...
class RequestParserTest {
     ...
     */
    @Test
    void parseHttpRequestwithContent(){
        HttpRequest req = null;
        try {
            req = reqParser.parseHttpRequest(
                    generateValidTestCaseWithContent()
            );
        } catch (ParsingException e) {
            fail(e);
        }
    ...
    @Test
    void parseHttpBadRequestwithContent(){
        HttpRequest req = null;
        try {
            req = reqParser.parseHttpRequest(
                    generateBadTestCaseWithContent()
            );
        } catch (ParsingException e) {
            fail(e);
        }
    ...
    private InputStream generateValidTestCaseWithContent() {
        String rawData = "GET / HTTP/1.1\r\n" +
                "Host: localhost:8080\r\n" +
                "auth: Hello\r\n" +
                "pass: nil\r\n" +
    ...
    private InputStream generateBadTestCaseWithContent() {
        String rawData = "GET / HTTP/1.1\r\n" +
                "Host: localhost:8080\r\n" +
                "auth: Hello\r\n" +
                "pass: nil\r\n" +
